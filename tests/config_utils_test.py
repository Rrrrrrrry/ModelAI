...
if __name__=="__main__":
    choose_model_name_options = ['rf', 'xgboost', 'lightgbm', 'catboost', 'mlp', 'vot']
    filter_label_list_options = [['A1'], ['A2'], ['B'], ['C'], ['D'], ['E']]
    train_well_file_name_options = [['214_out.csv', '217_out.csv', 'N201_20240301.csv', 'N209_20240301.csv'],
                                    ['214_out.csv', '217_out.csv', 'N201_20240301.csv', 'N211_20240301.csv'],
                                    ['214_out.csv', '217_out.csv', 'N209_20240301.csv', 'N211_20240301.csv'],
                                    ['214_out.csv', 'N201_20240301.csv', 'N209_20240301.csv', 'N211_20240301.csv'],
                                    ['217_out.csv', 'N201_20240301.csv', 'N209_20240301.csv', 'N211_20240301.csv']]
    ...
    for choose_model_name, filter_label_list, train_well_file_name_combination, float_test_data in itertools.product(
            ...
            float_test):
        try:
            logging.info(f"choose_model_name0{choose_model_name}")
            logging.info(f"filter_label_list{filter_label_list}")
            logging.info(f"train_well_file_name_combination{train_well_file_name_combination}")
            # 修改配置文件
            ...
            modify_config_file(config_file, {"choose_model_name": choose_model_name,
                                             ...
                                             "train_well_file_name_combination": train_well_file_name_combination,
